...
var (
	...
	EphemeralStorageReservationPercent = NewWorkloadMetricHolder(Ephemeral, Storage, Reservation, Percent)
	EphemeralStorageUsageBytes         = NewWorkloadMetricHolder(Ephemeral, Storage, Usage, Bytes)
