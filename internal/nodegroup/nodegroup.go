...
var resourceCoreQueries = map[string]map[bool]map[string]string{
	common.Limit: {
		true: {
			common.Cpu:    `kube_pod_container_resource_limits{resource="cpu"} or (kube_pod_init_container_resource_limits{resource="cpu"} * on (namespace, pod, container, uid) group_left max by (namespace, pod, container, uid) (kube_pod_init_container_info{restart_policy="Always"}))`,
			common.Memory: `kube_pod_container_resource_limits{resource="memory"} or (kube_pod_init_container_resource_limits{resource="memory"} * on (namespace, pod, container, uid) group_left max by (namespace, pod, container, uid) (kube_pod_init_container_info{restart_policy="Always"}))`},
		false: {
	...
	common.Request: {
		true: {
			common.Cpu:    `kube_pod_container_resource_requests{resource="cpu"} or (kube_pod_init_container_resource_requests{resource="cpu"} * on (namespace, pod, container, uid) group_left max by (namespace, pod, container, uid) (kube_pod_init_container_info{restart_policy="Always"}))`,
			common.Memory: `kube_pod_container_resource_requests{resource="memory"} or (kube_pod_init_container_resource_requests{resource="memory"} * on (namespace, pod, container, uid) group_left max by (namespace, pod, container, uid) (kube_pod_init_container_info{restart_policy="Always"}))`},
		false: {
